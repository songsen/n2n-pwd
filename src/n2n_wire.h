...
#define N2N_USER_PASSWD                 16
#define N2N_ACCOUNT_SIZE                20
...
typedef uint8_t n2n_account_t[N2N_ACCOUNT_SIZE];

typedef uint8_t n2n_user_passwd_t[N2N_USER_PASSWD];
...
struct n2n_REGISTER_SUPER
{
    ...
    n2n_account_t       account;
    //n2n_user_passwd_t passwd;
};
